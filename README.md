...
Около 10 лет я работала в сфере обслуживания корпоративных клиентов. За это время научилась находить к ним подход и доступно объяснять сложные вещи.

На последнем месте работы много взаимодействовала с дашбордами как пользователь, а также давала обратную связь аналитикам по ошибкам и улучшениям. Мне стало интересно, как это всё устроено внутри, и я прошла курс по аналитике данных и BI-аналитике.
...
⭐️ *Буду рада новым знакомствам и интересным проектам!*
